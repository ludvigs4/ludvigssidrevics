...
cukurs_summa = math.ceil(cukurs_daudzums - cukurs_majas) * cukurs_cena * litri
citrons_summa = math.ceil(citrons_daudzums - citrons_majas) * citrons_cena * litri
kanelis_summa = math.ceil(kanelis_cena * (kanelis_daudzums - kanelis_majas)) * litri

print("Cukurs maksā", round(cukurs_summa, 2), "EUR")
print("Citrons maksā", round(citrons_summa, 2), "EUR")
print("Kanelis maksā", round(kanelis_summa, 2), "EUR")